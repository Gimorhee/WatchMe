  ...
  return (
    <div className="Details">
      <div className="Details-Top">
        ...
        <p>
          Watch Me has been providing immaculate services to all of our clients
          by designing, reparing and customizing timepieces synonymous with
          reliability, accuracy and precision. We offer a wide assortment of
          Classic and Luxury watch models to suit any wrist. Discover the broad
          selection of watches to find a superior combination of style and
          functionality.
        </p>
      </div>
      <div className="Details-Bottom">
        <div className="Details-Infos">
          ...
          <div className="Details-Info">
            ...
            <div className="Inner-Info">
              <p>
                <span>‟</span>I know what I want and I'g gonna get it. It's that
                simple
                <span>”</span>
              </p>
            </div>
